        ...
        <>
            ...
            <div className='container mt-2'>
                ...
                <div className='text-end'>
                    <Button variant="primary"><NavLink to="/product" className="text-decoration-none text-light">Add User</NavLink></Button>
                </div>
                                ...
                                <>
                                    <Card style={{ width: '22rem', height: "18rem" }} className="mb-3">
                                        ...
                                        <Card.Body className='text-center'>
                                            ...
                                            <Button variant="danger" className='col-lg-4 mx-2 text-center' onClick={() => dltUser(el._id)}>Delete</Button>
                                            {/* <Button variant="warning" className='col-lg-4  text-center' >Update</Button> */}
                                            <Link to={"/product/" + el._id}>update</Link>
                                        </Card.Body>
                                    </Card>
                                </>
                            )
